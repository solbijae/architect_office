...
import { ProfileContainer, ProfileNav, ProfileWrap, NavItem, ProfileInfoWrap, TeamProfileWrap } from 'styles/Profile';
    ...
    <ProfileContainer>
      ...
      <ProfileNav>
        ...
        {clickedOption === 'HYUNJOON YOO' && 
          <ProfileWrap>
            <img src="/assets/images/profile/hyunjoonyoo.jpg" alt="Hyunjoon Yoo profile" />
            <ProfileInfoWrap>
              <div>
                <h3>DESCRIPTION</h3>
                <ul>
              ...
              <div>
                <h3>EDUCATION</h3>
                <ul>
                  <li>Harvard University, Master of Architecture with Distinction</li>
              ...
              <div>
                ...
                <ul>
                  ...
                  <li>MIT Architecture Representation & Computation Lab MIT Visiting Scholar</li>
                </ul>
              </div>
              <div>
                <h3>BOOKS</h3>
                <ul>
                  ...
                  <li>Architectural Trip to Humanity | Eulyoo Publishing | 2023</li>
                  ...
                  <li>Modernism: A Hybrid of Eastern and Western Culture - Chinese/English edition | 2012</li>
                  <li>52 9 12 | Meeseum | 2011</li>
                  <li>The Flow of Contemporary Architecture | Meeseum | 2009</li>
                  <li>Modernism: Cultural Hybrid of East and West | Meeseum | 2008</li>
                </ul>
              </div>
              <div>
                <h3>COLUMN</h3>
